...
- **Frequency:** Annual  
- **Data sources:**  
  - Government expenditure data (public finance statistics)  
  - Macroeconomic indicators (national accounts)
---
## Key Variables

### Dependent Variable
- **Economic growth** (GDP growth or real GDP)

### Independent Variables
- Total government expenditure
- Components of government expenditure (e.g., recurrent and development spending)
- Control macroeconomic variables (where applicable)
---
## Methodology

### Exploratory Data Analysis
- Trend analysis of government expenditure and economic growth
- Descriptive statistics
- Time-series visualization
---
### Time-Series Econometric Analysis
The following econometric techniques were applied:
...
- **Granger causality tests**
  - Direction of causality between government expenditure and economic growth
---
## Model Diagnostics
- Stationarity verification
- Residual diagnostics
- Stability of estimated relationships
- Interpretation of short-run vs long-run coefficients
---
## Key Findings
